function Popup(coache) {
  return (
    <div className="coaches__info_overlay">
        <div className="coaches__info" id={coache.id}>
        <div className="coaches__info_top">
            ...
            <div className="coaches__info_close">Закрыть</div>
        </div>

        <div className="coaches__info_bottom">
            <div className="coaches__info_chapter">
            <h3 className="coaches__info_chapter_title">Образование</h3>
            <div className="coaches__item_edu">{coache.education}</div>
            <div className="coaches__item_course">{coache.course}</div>
            </div>
            <div className="coaches__info_chapter">
            <h3 className="coaches__info_chapter_title">Опыт работы</h3>
            <div className="coaches__item_experience">{coache.experience}</div>
            </div>
            <div className="coaches__info_chapter">
            <h3 className="coaches__info_chapter_title">Награды</h3>
            <div className="coaches__item_awards">{coache.awards}</div>
            </div>
        </div>
        </div>
    </div>
