    ...
    <div className="app-container">
      <header className="header" id="header">
        <div className="container">
          <div className="header__row">
            ...
            <div className="header__phone_mobile">
              <a href="tel:+7 800 000 11 22">
          ...
          <div className="container">
            <div className="promo__row">
              <div className="promo__row_left">
                ...
                <a href="#rate" className="btn btn--sign">Записаться на курс
                </a>
              </div>
              <div className="promo__row_right">
                <svg
                  className="promo__row_right promo__row_right-1"
                  width="783"
                  height="784"
                  viewBox="0 0 783 784"
                  fill="none"
                ...
                <img
                  className="promo__row_right promo__row_right-2"
            ...
            <div className="course__row">
              ...
              <div className="course__what">
                <div className="course__what_col">
                  ...
                  <div className="course__what_text">
                ...
                <div className="course__what_col">
                  <div className="course__what_title">
                    Практику
                    <span className="course__what_title-span">
                      <button className="tip">
                      </button>
                      <span className="tip-hover">
            ...
            <div className="rate__row">
              ...
              <ul className="rate__fee">
                <li className="rate__fee_col">
                  ...
                  <div className="rate__fee_col-description">
      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer__row_footer">&copy; ROBO.SCHOOL</div>
        </div>
      </footer>
    </div>
  );
